{{-- resources/views/dashboard/user/products/edit.blade.php --}}
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Edit Produk - {{ $product->name }} - UMKMCenter.id</title>
    ...
    {{-- Opsional: Jika ada CSS spesifik untuk form atau dashboard user --}}
